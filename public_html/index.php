...
defined('DATA_PATH') || define('DATA_PATH', realpath(dirname(__FILE__) . '/../data')); 						// Defino la ruta de la carpeta application
defined('UPLOAD_PATH') || define('UPLOAD_PATH', realpath(dirname(__FILE__) . '/uploads/files')); 						// Defino la ruta de la carpeta application
...
define('NAMESPACE_APP',NAMESPACE_BASE.'_Cert');																							// Namespace unico para la app execpto para EasyAutomation que tiene que estar en blanco
